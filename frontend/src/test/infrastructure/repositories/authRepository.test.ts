  ...
  describe('getCurrentUser', () => {
    ...
    describe('正常系', () => {
      ...
      it('現在のユーザー情報を取得して返せる', async () => {
        ...
        expect(
          api.requestrFetchValidateToken,
  ...
  describe('updatePassword', () => {
    ...
    describe('異常系', () => {
      ...
      it('APIのステータスが200以外の場合はエラーになる', async () => {
        ...
        await expect(
          authRepository.updatePassword(params),
        ).rejects.toThrow('updatePassword unexpected status')
